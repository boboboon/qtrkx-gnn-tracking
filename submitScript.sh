...
#SBATCH -o /home/xzcaplcu/repo/qtrkx-gnn-tracking/slurms/10output.out
#SBATCH -e /home/xzcaplcu/repo/qtrkx-gnn-tracking/slurms/10error.out
...
srun python3 train.py configs/remote_MPS.yaml MPS-3
